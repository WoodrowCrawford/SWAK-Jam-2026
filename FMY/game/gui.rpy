...
define gui.accent_color = '#2fbb3d'

## The color used for a text button when it is neither selected nor hovered.
define gui.idle_color = '#3a624d'

## The small color is used for small text, which needs to be brighter/darker to
## achieve the same effect.
define gui.idle_small_color = '#1a521f'
...
define gui.text_font = "font/sitka-small-815.ttf"

## The font used for character names.
define gui.name_text_font = "font/sitka-small-815.ttf"

## The font used for out-of-game text.
define gui.interface_text_font = "font/sitka-small-815.ttf"
